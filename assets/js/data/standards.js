...
SHE.CHEMICALS = [
  ...
  { id: 'w', cat: 'metal', ko: '텅스텐 및 불용성화합물 (호흡성)', en: 'Tungsten & insoluble compounds (respirable)', f: 'W', cas: '7440-33-7', unit: 'mg/m³', twa: 5, stel: 10, c: null, note: { ko: '가용성화합물은 TWA 1·STEL 3mg/m³ — 플라즈마 식각 대상 금속막 (OSHA Table 3), 금속배선의 깊은 구멍 갭필 (SK하이닉스 뉴스룸)', en: 'Soluble compounds: TWA 1, STEL 3 mg/m³ — a metal film etched in plasma (OSHA Table 3); gap-fill of deep holes in metallization (SK hynix Newsroom)' }, idlh: null, procs: ['etch', 'metal'] },
  { id: 'ta', cat: 'metal', ko: '탄탈륨 (금속 및 산화흄)', en: 'Tantalum (metal & oxide fume)', f: 'Ta', cas: '7440-25-7', unit: 'mg/m³', twa: 5, stel: null, c: null, note: { ko: '고시 별표1은 Ta/Ta₂O₅(1314-61-0)로 수록 — 플라즈마 식각 대상 금속막 (OSHA Table 3), 구리 배선의 확산 방지막 (SK하이닉스 뉴스룸)', en: 'Annex 1 lists it as Ta/Ta₂O₅ (1314-61-0) — a metal film etched in plasma (OSHA Table 3); diffusion barrier for copper lines (SK hynix Newsroom)' }, idlh: 2500, idlhUnit: 'mg/m³', procs: ['etch', 'metal'] },
  ...
  /* 6단계(2026-09-25) — 공정 사용 근거: SK하이닉스 뉴스룸 공정 해설(nrMetal·nrDepo·nrAld·nrScrubber·nrWlp), 미국 EPA 40 CFR 98 표 I-3·I-4·I-21(epaGhg).
     노출기준: 고시 별표1 원문, IDLH: NIOSH, CAS·지구온난화지수(100년): EPA 표 A-1(트라이메틸알루미늄 CAS는 미국 NIH PubChem) */
  { id: 'cu', cat: 'metal', ko: '구리 (분진·미스트, Cu로서)', en: 'Copper (dust & mist, as Cu)', f: 'Cu', cas: '7440-50-8', unit: 'mg/m³', twa: 1, stel: 2, c: null, note: { ko: '구리 흄은 TWA 0.1mg/m³ — 금속배선(구리 배선, 탄탈륨 배리어)과 웨이퍼 레벨 패키지의 구리 전해도금 (SK하이닉스 뉴스룸)', en: 'Copper fume: TWA 0.1 mg/m³ — metallization (copper lines with a tantalum barrier) and copper electroplating in wafer-level packaging (SK hynix Newsroom)' }, idlh: 100, idlhUnit: 'mg/m³', psrc: ['nrMetal', 'nrWlp'], procs: ['metal', 'wlp'],
    icsc: { ko: '미세한 분말은 공기와 폭발성 혼합물을 만듦. 흄을 흡입하면 금속열(금속흄열)이 생길 수 있음', en: 'Finely dispersed particles form explosive mixtures in air. Inhaling the fume may cause metal fume fever.' } },
  { id: 'cobalt', cat: 'metal', ko: '코발트 및 그 무기화합물 (Co로서)', en: 'Cobalt & inorganic compounds (as Co)', f: 'Co', cas: '7440-48-4', unit: 'mg/m³', twa: 0.02, stel: null, c: null, note: { ko: '발암성 2 — 금속배선 콘택 형성·금속 증착 (SK하이닉스 뉴스룸)', en: 'Carc. 2 — contact formation in metallization and metal deposition (SK hynix Newsroom)' }, idlh: 20, idlhUnit: 'mg/m³', psrc: ['nrMetal', 'nrDepo'], procs: ['metal', 'dep'],
    icsc: { ko: '미세한 분말은 공기와 폭발성 혼합물을 만들고 자연발화할 수 있음. 반복 흡입하면 천식, 반복 접촉하면 피부 감작이 생길 수 있음', en: 'Fine powder forms explosive mixtures in air and may ignite spontaneously. Repeated inhalation may cause asthma; repeated contact may cause skin sensitisation.' } },
  { id: 'tma', cat: 'solv', ko: '트라이메틸알루미늄(TMA)', en: 'Trimethylaluminium (TMA)', f: 'Al(CH₃)₃', cas: '75-24-1', unit: 'mg/m³', twa: 2, stel: null, c: null, note: { ko: '고시 별표1 ‘알루미늄(알킬)’ 호흡성 기준 — 원자층 증착(ALD)의 1차 소스 (SK하이닉스 뉴스룸). 위험물 제3류 알킬알루미늄(지정수량 10kg)', en: 'Annex 1 “aluminium (alkyls)”, respirable fraction — first source in atomic layer deposition (SK hynix Newsroom). Class 3 dangerous substance, alkylaluminium (designated quantity 10 kg)' }, idlh: null, psrc: ['nrAld'], procs: ['dep'] },
  { id: 'cf4', cat: 'fgas', ko: '사불화탄소(CF₄, PFC-14)', en: 'Tetrafluoromethane (CF₄, PFC-14)', f: 'CF₄', cas: '75-73-0', unit: 'ppm', twa: null, stel: null, c: null, note: { ko: '국내 노출기준 없음 — 식각 공정 가스, 스크러버로 분해 (SK하이닉스 뉴스룸; EPA 표 I-3·I-4). 지구온난화지수 6,630', en: 'No Korean limit — etch-process gas broken down in scrubbers (SK hynix Newsroom; EPA Tables I-3, I-4). GWP 6,630' }, idlh: null, psrc: ['nrScrubber', 'epaGhg'], procs: ['etch'],
    icsc: { ko: '화재 시 자극성·독성 흄 발생. 공기보다 무거워 낮은 곳에 모이면 산소 결핍, 고농도 흡입 시 어지러움·부정맥·의식 저하. 접촉 시 동상', en: 'Gives off irritating or toxic fumes in a fire. Heavier than air — pools in low spaces and causes oxygen deficiency; high levels cause dizziness, irregular heartbeat and unconsciousness. Contact causes frostbite.' } },
  { id: 'chf3', cat: 'fgas', ko: '트리플루오로메탄(CHF₃, HFC-23)', en: 'Trifluoromethane (CHF₃, HFC-23)', f: 'CHF₃', cas: '75-46-7', unit: 'ppm', twa: null, stel: null, c: null, note: { ko: '국내 노출기준 없음 — 식각·웨이퍼 세정 가스 (EPA 표 I-3·I-4). 지구온난화지수 12,400', en: 'No Korean limit — etch and wafer-clean gas (EPA Tables I-3, I-4). GWP 12,400' }, idlh: null, psrc: ['epaGhg'], procs: ['etch'],
    icsc: { ko: '뜨거운 표면·화염에 닿으면 분해되어 불화수소 등 독성 흄 발생. 공기보다 무거워 낮은 곳에서 산소 결핍, 액체 접촉 시 동상, 부정맥 가능', en: 'Decomposes on hot surfaces or flames, giving toxic fumes including hydrogen fluoride. Heavier than air — oxygen deficiency in low spaces; liquid causes frostbite; may cause cardiac arrhythmia.' } },
  { id: 'c2f6', cat: 'fgas', ko: '헥사플루오로에탄(C₂F₆, PFC-116)', en: 'Hexafluoroethane (C₂F₆, PFC-116)', f: 'C₂F₆', cas: '76-16-4', unit: 'ppm', twa: null, stel: null, c: null, note: { ko: '국내 노출기준 없음 — 식각·웨이퍼 세정 가스 (EPA 표 I-3·I-4). 지구온난화지수 11,100', en: 'No Korean limit — etch and wafer-clean gas (EPA Tables I-3, I-4). GWP 11,100' }, idlh: null, psrc: ['epaGhg'], procs: ['etch'] },
  { id: 'c4f8', cat: 'fgas', ko: '옥타플루오로사이클로부탄(c-C₄F₈, PFC-318)', en: 'Octafluorocyclobutane (c-C₄F₈, PFC-318)', f: 'c-C₄F₈', cas: '115-25-3', unit: 'ppm', twa: null, stel: null, c: null, note: { ko: '국내 노출기준 없음 — 식각·웨이퍼 세정 가스 (EPA 표 I-3·I-4). 지구온난화지수 9,540', en: 'No Korean limit — etch and wafer-clean gas (EPA Tables I-3, I-4). GWP 9,540' }, idlh: null, psrc: ['epaGhg'], procs: ['etch'] },
  { id: 'c4f6', cat: 'fgas', ko: '헥사플루오로-1,3-부타디엔(C₄F₆)', en: 'Hexafluoro-1,3-butadiene (C₄F₆)', f: 'C₄F₆', cas: '685-63-2', unit: 'ppm', twa: null, stel: null, c: null, note: { ko: '국내 노출기준 없음 — 식각·웨이퍼 세정 가스 (EPA 표 I-3·I-4). 지구온난화지수 0.003 (EPA 표 A-1)', en: 'No Korean limit — etch and wafer-clean gas (EPA Tables I-3, I-4). GWP 0.003 (EPA Table A-1)' }, idlh: null, psrc: ['epaGhg'], procs: ['etch'] }
];
...
(function () {
  const META = {
    ...
    cu: ['0240', 'wsm'], cobalt: ['0782', 'wsm'], tma: [null, 'wsm'], cf4: ['0575', ''], chf3: ['0577', ''], c2f6: [null, ''], c4f8: [null, ''], c4f6: [null, '']
  };
  const RGC = {
    ...
    tma: { ko: '‘알루미늄 및 그 화합물’ 항목으로 해당', en: 'Covered as “aluminium and its compounds”' },
